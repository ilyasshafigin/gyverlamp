...
// Effect: Velvet Folds - Бархатные складки
// Мягкая ткань света, лежащая по диагонали. По ней медленно проходят длинные складки: одни части слегка подсвечиваются,
// другие уходят в насыщенную тень. Дополнительная слабая волна поперёк создаёт ощущение объёма, но не превращает эффект в хаотичный шум.
