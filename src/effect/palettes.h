...
DECLARE_GRADIENT_PALETTE(OptimusPrime_gp);
DECLARE_GRADIENT_PALETTE(Warm_gp);
DECLARE_GRADIENT_PALETTE(Cold_gp);
DECLARE_GRADIENT_PALETTE(Hot_gp);
DECLARE_GRADIENT_PALETTE(Pink_gp);
DECLARE_GRADIENT_PALETTE(Comfy_gp);
DECLARE_GRADIENT_PALETTE(Cyperpunk_gp);
DECLARE_GRADIENT_PALETTE(Girl_gp);
DECLARE_GRADIENT_PALETTE(Xmas_gp);
DECLARE_GRADIENT_PALETTE(Acid_gp);
DECLARE_GRADIENT_PALETTE(BlueSmoke_gp);
