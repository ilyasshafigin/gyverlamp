...
// Modified 2026-09-21: renamed the public class to UptimeFormatter.
UptimeFormatter::UptimeFormatter() {
}

//returns the actual time passed since device boot
//in the format: x days, y hours, z minutes, s seconds
String UptimeFormatter::uptime() {
  Uptime::calculateUptime();

  return String(Uptime::days()) + " days, " + String(Uptime::hours()) + " hours, " + String(Uptime::minutes()) +
         " minutes, " + String(Uptime::seconds()) + " seconds";
}

//returns the actual time passed since device boot
//in the format: x days, y hours, z minutes, s seconds, n milliseconds
String UptimeFormatter::uptimeWithMillis() {
  return UptimeFormatter::uptime() + ", " + String(Uptime::milliseconds()) + " milliseconds";
}
