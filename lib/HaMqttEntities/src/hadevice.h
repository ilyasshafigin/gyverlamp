...
public:
  ...
  inline void setHwVersion(const char* hw_version) { this->hw_version = hw_version; }
  ...
  bool sendAvailable(PubSubClient* mqttClient, bool force);

private:
  friend class HAMQTTController;
