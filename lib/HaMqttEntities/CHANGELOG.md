...
## [GyverLamp vendored snapshot] - 2026-09-05

- Baseline: upstream `paulino/ha-mqtt-entities` version 1.0.12.
- Added project HALight entity with brightness, effect, and RGB support.
- Added project HATime entity with normalized `HH:MM` state.

## [1.0.12] - 2026-05-04

- Changed dependency to PubSubClient3
- Improved MQTT broker reconnection
